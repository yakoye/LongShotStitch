...
const required = [
  ...
  'showAbout',
  'LongShotStitch v1.45.0',
  '<span class="mode-label">标注',
  "['select','select','选择 / 变换']",
  "['marquee','marquee','选区']",
  "selectionShape:'rect'",
  'data-selection-shape="rect"',
  'data-selection-shape="ellipse"',
  'data-selection-shape="free"',
  'selectionPath',
  'drawSelectionPath',
