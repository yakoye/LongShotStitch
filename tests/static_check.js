...
const htmlPath = path.join(root, 'LongShotStitch_v1.11.html');
if (!fs.existsSync(htmlPath)) throw new Error('Missing LongShotStitch_v1.11.html');
const html = fs.readFileSync(htmlPath, 'utf8');

const checks = [
  ['title version', 'LongShotStitch v1.11'],
  ...
  ['future features doc expected', 'LongShotStitch v1.11'],
...
console.log('Static check passed: LongShotStitch_v1.11.html');
